...
export const SearchInput = () => {
  ...
  const [analyzeConferenceState, analyzeConferenceAction, isPending] = useActionState(
    analyzeConference,
    {
      success: false,
      error: ''
  ...
  return (
    <div ref={selectRef} className='relative mx-auto w-full max-w-xs' onClick={selectMenu.open}>
