...
export interface ConferenceFeedTalkItemProps {
  talk: TalkWithReactions;
}

export const ConferenceFeedTalkItem = ({
  talk,
}: ConferenceFeedTalkItemProps) => {
    ...
    <div className="flex flex-col items-start justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {!!optimisticTalk.likes && (
            <span className="text-medium">{optimisticTalk.likes}</span>
          )}
        </DynamicBadge>
